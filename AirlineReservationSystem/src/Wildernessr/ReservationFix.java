...
public class ReservationFix {
	...
	String totalPlaneInfo() {
		String DateInfo = ("가는편 날짜" + GoDate + "\n오는편 날짜" + BackDate);
	...
	public void ss() {
		try {
			...
			System.out.println("가는편비행기" + 
					dateFormat.format(date1));
			System.out.println("오는편비행기" +
